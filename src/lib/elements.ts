...
export function findElements(text: string, filename = 'Element.php') {
 ...
 */
export function formatElementSnippetString(name: string, type: string, docs: PHP.CommentBlock | undefined) {
 ...
 */
export function formatElementDocumentation({ name, type, docs }: { name: string, type: string, docs: PHP.CommentBlock | undefined }) {
  const desc = [];
 ...
 */
export function formatElement({ name, type, docs }: { name: string, type: string, docs: PHP.CommentBlock | undefined }) {
